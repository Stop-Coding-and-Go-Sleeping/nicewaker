...
public class MainActivity extends AppCompatActivity {
    ...
    public void Register2(View view) {
        ...
        try {
            ...
            new AlertDialog.Builder(this).setTitle("Congratulations!").setMessage("Your account has been created.").setPositiveButton("Ok", null).show();
        } catch (SQLiteConstraintException e) {
            Log.i("register", "Register2: fail");
            new AlertDialog.Builder(this).setTitle("Attention").setMessage("Username already taken, please try something else.").setPositiveButton("Ok", null).show();
        } finally {
            db.endTransaction();
        }
